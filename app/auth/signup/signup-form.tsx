...
const OAUTH_REDIRECT_ERROR =
  'Google sign-up is configured for a different host. Check the Supabase Auth redirect URLs for this environment.'
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-xs text-center text-muted-foreground">
        By signing up, you agree to receive email alerts about meetings
        matching your keywords. You can unsubscribe at any time.
      </p>
    </div>
  )
}
